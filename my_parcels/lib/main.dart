...
import 'package:my_parcels/injections/modules.dart';
import 'package:my_parcels/my_parcels_app.dart';
...
Future<void> main() async {
  ...
  runApp(
    MultiProvider(
      providers: [
        Provider<AppTypography>.value(value: AppTypography.myParcels),
